...
{
    for (int j = 1; j <= i; j++) {
        if (st[i].roll <= 10 && st[i].roll>9)
        	printf("Grade: O");
        else if(st[i].roll<=9 && st[i].roll>8)
            printf("Grade: E");
        else if(st[i].roll<=8 && st[i].roll>7)
            printf("Grade: A");
        else if(st[i].roll<=7 && st[i].roll>6)
            printf("Grade: B");
        else if(st[i].roll<=6 && st[i].roll>5)
            printf("Grade: C");
        else if(st[i].roll<=5 && st[i].roll>4)
            printf("Grade: D");
        else if(st[i].roll<=4 && st[i].roll>=0)
            printf("You are FAIL!!!!");
        else 
            printf("Wrong INPUT!!!");
 	}}
